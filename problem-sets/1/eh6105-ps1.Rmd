...
8. Suppose I wanted to create a `cold_war` dummy variable that equals 1 if the crisis occurred on or before 1990 and equals a 0 if it occurred afterward. How might I do that?
