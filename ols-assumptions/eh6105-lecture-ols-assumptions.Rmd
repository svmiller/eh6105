...
Third scenario: this is an instrumental variable problem (which you'll learn about in the advanced class).

- Even these have their own peculiarities.
...
broom::augment(M3) %>%
  ...
  labs(x = "Fitted Values", y = "Residuals",
       ...
       caption = "Data: fake data from this lecture. See previous slides.")
